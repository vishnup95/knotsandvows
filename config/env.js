...
const BAKED_IN_ENV_VARS = ['NODE_ENV', 'PUBLIC_URL', 'VERSION', 'API_HOST', 'API_PORT', 'REACT_APP_GA_TRACKING_ID','REACT_APP_FS_ORG_ID'];
...
function getAppEnv() {
  const raw = Object.keys({}).reduce(
    ...
    },
    {
      ...
      REACT_APP_FS_ORG_ID: process.env.REACT_APP_FS_ORG_ID,
    }
  );
