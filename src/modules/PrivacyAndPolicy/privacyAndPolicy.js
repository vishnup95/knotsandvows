...
const listData1 = [
  {
    ...
    description: 'Our site has stringent security measures in place to protect the loss, misuse, and alteration of the information under our control. Whenever you change or access your account information, we offer the use of a secure server. Once your information is in our possession we adhere to strict security guidelines, protecting it against unauthorized access. Knots&Vows ensures that every transaction that takes between you and our Knots&Vows through online is in a safe and secure environment. This can be achieved, as Knots&Vows is protected by Secured Socket Layer (SSL) technology.'
  },
  {
    heading: 'COLLECTION OF PERSONALLY IDENTIFIABLE INFORMATION',
    description: 'We collect personally identifiable information (Email Id., Name, Contact number, etc.) from you when you make payment. Anyone can browse some sections of our site without being consumer of the Knots&Vows Certain activities (such as applying for the Complaint Status, etc) do require Registration. We do use your contact information to send you information.'
  },
  {
...
const listData2 = [
  ...
  },
  {
    ...
    description: 'As a condition for the use of the Knots&Vows , the User warrants that they will not use the app for any purpose that is unlawful or illegal under any law for the time being in force within or outside India or prohibited by this Agreement. In addition, the Knots&Vows shall not be used in any manner, which could damage, disable, overburden or impair it or interfere with any other party’s use of the app. The User shall refrain from obtaining or attempting to obtain any materials or information through any means not intentionally made available or provided for or through the app.'
  },
  {
    heading: 'USE OF COMMUNICATION SERVICES',
    description: 'Knots&Vows may contain services such as email, News bulletin, information related to Regional or local help centers, and/or other message (hereinafter collectively referred to as “Communication Services”). The User agrees and undertakes to use the Communication Services only to post, send and receive messages and material that are proper and related to the Knots&Vows. By way of example, and not as a limitation, the User agrees and undertakes that when using a Communication Service, the User will not:',
    sublist: [
      ...
      'Upload or distribute files that contain viruses, corrupted files, or any other similar software or programs that may damage the operation of the Knots&Vows or another’s computer.',
...
const listData3 = [
  {
    ...
    description: 'Knots&Vows reserves the right, in its sole discretion, to terminate the access to the app and the related services or any portion thereof at any time, without notice.'
  }
]
