                        ...
                        <Collapse isOpen={this.state.collapse[1]}>
                            ...
                            <ul>
                                <li className="d-block d-sm-none text-left">
                                    <Link to={'/'} onClick={()=>{if(window!=null) window.gtag_report_conversion('http://localhost:3000/');}}>Home</Link>
                                </li>
                                <li>
                                    <Link to={'/categories'} onClick={()=>{if(window!=null) window.gtag_report_conversion('http://localhost:3000/categories');}}>VowVendors</Link>
                                </li>
                                <li>
                                    <Link to={'/#packages'} onClick={()=>{if(window!=null) window.gtag_report_conversion('http://localhost:3000/#packages');}}>Packages</Link>
                                </li>
                                <li>
                                    <Link to={'/#ceremonies'} onClick={()=>{if(window!=null) window.gtag_report_conversion('http://localhost:3000/#ceremonies');}}>Ceremonies</Link>
                                </li>
                                <li>
                                ...
                                <li>
                                    <Link to={'/who-we-are'} onClick={()=>{if(window!=null) window.gtag_report_conversion('http://localhost:3000/who-we-are');}}>Who We Are</Link>
                                </li>
                                <li>
                                ...
                                <ul>
                                    {
                                        this.props.ceremonies.map((ceremony, index) => {
                                            return (
                                                <li key={index}>
                                                    <Link to={`/ceremonies/${hyphonatedString(ceremony.ceremony_name,ceremony.ceremony_id) }`} onClick={()=>{if(window!=null) window.gtag_report_conversion(`http://localhost:3000/${hyphonatedString(ceremony.ceremony_name,ceremony.ceremony_id) }`);}}>{ceremony.ceremony_name}</Link>
                                                </li>
                                            );
                                        })
                                    }
