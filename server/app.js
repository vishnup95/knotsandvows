...
app.use(helmet.contentSecurityPolicy({
  directives: {
    ...
    scriptSrc: ["'self'", "'unsafe-inline'", "'unsafe-eval'", '*.googleapis.com', 'maxcdn.bootstrapcdn.com', '*.google-analytics.com', '*.googletagmanager.com', '*.facebook.net', 'https://fullstory.com', '*.google.com', '*.googleadservices.com', '*.doubleclick.net','*.purechat.com', '*.purechatcdn.com','*.secure.gravatar.com'],
    ...
    imgSrc: ["'self'", 'data:', '*.facebook.com', '*.google.com', '*.google.co.in', '*.cloudfront.net', '*.google-analytics.com', '*.ahwanam.com', '*.doubleclick.net','*.purechat.com', '*.purechatcdn.com','secure.gravatar.com','i1.wp.com'],
